...
def select_candidates_ratio(df_entries,threshold):
    list_flux_dict = {}
...
if __name__ == "__main__":
    ...
    list_flux_dict_up=select_candidates_ratio(df_entries,5)
    
    list_flux_dict_down=select_candidates_ratio(df_entries,2)
    ...
    c = coordinates.SkyCoord(ra=df_results_group['RA']*u.deg, dec=df_results_group['DEC']*u.deg, frame='icrs')
    r = 3*df_results_group['POSERR']* u.arcsec

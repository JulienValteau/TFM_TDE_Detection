...
# * //
# * // System : HILIGT flux and upper limit server
# * //
# * // This file is subject to the terms and conditions defined in 'LICENSE.txt',
# * // which is part of this source code package.
# * // No part of the package, including this file, may be copied,
...
def main():
    ...
    missions = ['Galex']
    #missions = ['eROSITA','XMMpnt','XMMslew','RosatSurvey','SwiftXRT','Ginga',
     #           "RosatPointedPSPC","RosatPointedHRI","Integral","ExosatLE",
      #          "ExosatME","Einstein","Ariel5","Heao1","NuSTAR","Sax","Asca",
       #         "Uhuru","Vela5B"]
...
def ULS_mission(mission, ra, dec, label, FORMAT):

    # Make a URL call to the upper limit server
    urlstring=("http://xmmuls.esac.esa.int/ULSnewservice_passthru?mission="
...
def getargs():
    ...
    if coord_file == "":
       if len(sys.argv)<3:
          print("Usage: client_multi.py ra dec <label> or "
                                        "client_multi.py --file=<filename>")
          exit()
       else:
          ra = args.ra
          dec = args.dec
